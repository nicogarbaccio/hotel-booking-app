...
## Key Features
1. **User Authentication**: Hassle-free login and registration experience with robust security measures, including HTTP cookies and JWT implementation.
2. **Hotel Management**: Seamlessly add, edit, and view hotels. This app covers everything from handling form inputs to efficient state management.
3. **Image Uploads**: Utilizes Cloudinary for image uploads, a crucial feature for any booking platform.
4. **Search, Sort, & Filter**: Functionalities to search, sort, and filter hotels, making it a breeze for users to find their perfect stay.
5. **Online Payments**: Integration with Stripe for secure and efficient hotel booking payments.
6. **Booking Management**: View and manage bookings, essential for any booking application.
...
```bash
git clone https://github.com/nicogarbaccio/hotel-booking-app.git
cd mern-booking-app
```
